...
namespace Tinkar.Dto
{
    ...
    public record DiGraphVertexDTO : GraphVertexDTO, IGraphVertex
    {
            ...
            where TBuilder : Builder<TBuilder>
        {
            ...
            public DiGraphVertexDTO Create()
            {
                ...
                return new DiGraphVertexDTO(this.VertexId,
                    ...
                    this.predecessors.ToImmutableArray(),
                    this.successors.ToImmutableArray());
            }
        }

        public ImmutableArray<Int32> Predecessors { get; init; }
        ...
        protected DiGraphVertexDTO(VertexId vertexId,
            ...
            ImmutableArray<Int32> predecessors,
        ...
        {
            base.Marshal(output);
            output.WriteInt32(this.Predecessors.Length);
