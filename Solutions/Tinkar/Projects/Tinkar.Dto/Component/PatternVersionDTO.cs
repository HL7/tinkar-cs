...
namespace Tinkar.Dto
{
        ...
        IMarshalable
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PatternVersionDTO"/> class.
        /// </summary>
        ...
        public override Boolean IsEquivalent(Object otherObject)
        {
            ...
            PatternVersionDTO other = otherObject as PatternVersionDTO;
            if (other == null)
                return false;
        ...
        public static PatternVersionDTO Make(TinkarInput input, IPublicId componentPublicId) =>
        ...
        public static PatternVersionDTO Make(
            JObject jsonObject,
            IPublicId componentPublicId) =>
                new PatternVersionDTO(componentPublicId,
