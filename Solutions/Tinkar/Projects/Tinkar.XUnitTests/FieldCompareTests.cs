...
namespace Tinkar.XUnitTests
{
    public class FieldCompareTests
    {
        ...
        public void FieldCompareTest()
        {
            ...
            {
                Assert.True(FieldCompare.Same(Misc.CreatePatternChronologyDTO,
                    Misc.CreatePatternChronologyDTO));
                Assert.False(FieldCompare.Same(
                    Misc.CreatePatternChronologyDTO,
                    Misc.CreatePatternChronologyDTO
                with
            ...
            {
                Object[] AArr() => new object[] { new PlanarPointDTO(10, 20), new SpatialPointDTO(20, 30, 40) };
                Object[] BArr() => new object[] { new PlanarPointDTO(10, 20), new SpatialPointDTO(20, 30, 50) };
